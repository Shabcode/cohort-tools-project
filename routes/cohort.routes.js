...
router.post("/api/cohorts", isAuthenticated, async (req, res, next) => {
    try {
...
router.get("/api/cohorts", isAuthenticated, async (req, res, next) => {
    try {
...
router.get("/api/cohorts/:cohortId", isAuthenticated, async (req, res, next) => {
    try {
...
router.put("/api/cohorts/:cohortId", isAuthenticated, async (req, res, next) => {
    try {
...
router.delete("/api/cohorts/:cohortId", isAuthenticated, async (req, res, next) => {
    try {
